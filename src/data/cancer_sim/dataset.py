...
from src.data.cancer_sim.cancer_simulation import AutoregressiveSimulation
...
class SyntheticVitalDatasetCollection(RealDatasetCollection):
    """
    ...
    def __init__(self,
        ...
        if test_cf:
            ...
            self.test_cf_one_step = MIMIC3RealDataset(treatments_cf, outcomes_cf_scaled, vitals_test, static_features_test, outcomes_cf_unscaled, scaling_params, 'test', coso_vitals_test,COSO_index)
