...
def cond_indep_test(data, var_index, target_index, cond_set=[], is_discrete=False, alpha=0.01):
    """
    Test for conditional independence between 'var_index' and 'target_index', 
